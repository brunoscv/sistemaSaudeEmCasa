        ...
        <div class="col-md-12">
            <div class="panel panel-white has-shadow">
				<div class="panel-heading clearfix">
					<h4 class="panel-title">Conselhos</h4>
					<a href="<?php echo site_url("conselhos/criar");?>" class="btn btn-primary pull-right"><span class="fa fa-plus"></span> Novo</a>
				</div>
								...
								<tr>
									...
									<td class="td-actions">
										<button type="button" 
												...
												data-anamation="true"
												data-html="true"
												data-content="<a href='<?php echo site_url("conselhos/editar/".$item->id); ?>' class='editar_info'>
																<p><i class='btn-icon-only fa fa-pencil'></i></span> Editar</p>
																<a href='<?php echo site_url("conselhos/delete/". $item->id); ?>' class='delete_info'>
