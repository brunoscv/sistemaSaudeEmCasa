	...
	<div class="row">
		<div class="col-xl-4 col-md-6">
			...
			<div class="card-body">
				<div class="row">
				<div class="col">
					<h5 class="card-title text-uppercase text-muted mb-0">Total de Atendimentos</h5>
		...
		<div class="col-xl-4 col-md-6">
			...
			<div class="card-body">
				<div class="row">
				<div class="col">
					<h5 class="card-title text-uppercase text-muted mb-0">Planos Atendidos</h5>
		...
		<div class="col-xl-4 col-md-6">
			...
			<div class="card-body">
				<div class="row">
				<div class="col">
					<h5 class="card-title text-uppercase text-muted mb-0">Novos Profissionais</h5>
            	...
            	<div class="card-header bg-transparent">
					<div class="row align-items-center">
						<div class="col">
							...
							<h5 class="h3 text-white mb-0">Atendimentos Realizados</h5>
						</div>
						<div class="col">
